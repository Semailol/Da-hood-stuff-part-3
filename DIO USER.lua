...
Animate.idle.Animation2.AnimationId = "http://www.roblox.com/asset/?id=1014390418"
	...
	table.insert(cors,sandbox(LocalScript1,function()
		...
		l__Parent__4.Equipped:connect(function(p1)
			...
			p1.Button1Down:connect(function()
                game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.Chat, false)                play(8326151965, true,true)
				if u5 then
					return;
				end;
				u5 = true;
			...
			p1.Button1Up:connect(function()
                game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)				u6 = false;
...
lp.Chatted:Connect(function(msg)
    if msg == "You have skills that ordinary people don't.." and speaking == false and ora == false then
speaking = true
play(6556675000, true, true)
wait(5.424)
speaking = false
end
    if msg == "Don't worry." and speaking == false and ora == false then
speaking = true
play(616594063, true, true)
wait(1.16)
speaking = false
end
    if msg == "Oh? You're approaching me DIO?" and speaking == false and ora == false then
speaking = true
play(5808893495, true, true)
wait(5.088)
speaking = false
end
end)
